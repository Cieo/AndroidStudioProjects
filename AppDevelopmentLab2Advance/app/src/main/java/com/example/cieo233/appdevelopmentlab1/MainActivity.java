...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // function to get all the views and init some varialbes
    void init() {
    ...
    // function to set the event listener
    void setResponse() {
    ...
    // the event function for the Button
    ...
    // the event function for the EditText
    @RequiresApi(api = Build.VERSION_CODES.KITKAT)
    @Override
